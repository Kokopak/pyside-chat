...
class Client(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.sendMessage = QtWidgets.QPushButton("Envoyer le message")
        self.sendMessage.clicked.connect(self.sendClick)

        self.messageLayout = QtWidgets.QHBoxLayout()
        self.messageLayout.addWidget(QtWidgets.QLabel("Message : "))
        ...
        self.connectButton = QtWidgets.QPushButton("Connexion")
        self.connectButton.clicked.connect(self.connection)
        self.connectButton.setDefault(True)

        self.connectionLayout = QtWidgets.QHBoxLayout()
        self.connectionLayout.addWidget(QtWidgets.QLabel("Serveur :"))
        self.connectionLayout.addWidget(self.serverInput)
        self.connectionLayout.addWidget(QtWidgets.QLabel("Port : "))
        self.connectionLayout.addWidget(self.portInput)
        self.connectionLayout.addWidget(QtWidgets.QLabel("Pseudo : "))
    ...
    def displayError(self):
        QtWidgets.QMessageBox.information(self, "Connexion", "Erreur de connexion")
